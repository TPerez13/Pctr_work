...
public class WaveEquationSec2 {
    ...
    public static void main(String[] args) {
        if (args.length != 1) {
            System.err.println("Uso: java WaveEquationSec <N>");
            return;
        }

        int N = Integer.parseInt(args[0]); // Leer N desde los argumentos
        ...
        System.out.println("Simulación completada. Resultados guardados en wave_output_sequential.txt.");
